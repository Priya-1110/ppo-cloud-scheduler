    ...
    import org.fog.utils.XGBoostClient;
    ...
    public class MultiCloudSchedulingSim {
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                csvWriter = new FileWriter("xgboost_log.csv");
            ...
            try {
                device = new FogDevice(name, characteristics, new AppModuleAllocationPolicy(hostList), new LinkedList<>(), 10, upBw, downBw, 0, latency) {
                    ...
                    public void processTupleArrival(org.cloudbus.cloudsim.core.SimEvent ev) {
                        ...
                        double selectedMips = 10000.0;
                        double avgRatePerMips = 0.07;
                        double estCost = cpuDemand * avgRatePerMips / 10000.0;

                        List<Double> featureVector = Arrays.asList(
                            FogUtils.generateRandomDouble(10, 100),     // CPU_Usage
                            FogUtils.generateRandomDouble(1024, 16384), // RAM
                            FogUtils.generateRandomDouble(50, 300),     // Disk_IO
                            FogUtils.generateRandomDouble(10, 100),     // Net_IO
                            FogUtils.generateRandomDouble(0.5, 10),     // Priority
                            estCost,                                     // Approx. cost
                            (double) memDemand                           // UserId as proxy
                        );

                        int selectedCloud = XGBoostClient.getPrediction(featureVector);
                        ...
                        try {
                            csvWriter.append(tupleCounter++ + "," + selectedCloud + "," +
                                    ...
                                    actualCost + "," + slaDeadline + "," + (slaMet ? "YES" : "NO") + "\n");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
